...
QSIRECON_OUT=/out/qsirecon/sub-${SUBJECTS}/dwi/sub-${SUBJECTS}_space-T1w_desc-preproc_fslstd
DTIFIT_OUT=dtifit/sub-${SUBJECTS}/dwi/sub-${SUBJECTS}_space-T1w_desc-dtifit
