...
# fmriprep_folder=${DERIVED_DIR}/fmriprep/fmriprep # use this path for fmriprep versions >= 20.2, unless fmriprep and freesurfer folders have been moved up one level
